...
#include "../../../UI/MainForm/MainForm/loginform.h"
...
QT_MOC_LITERAL(1, 10, 16), // "userPrivilSignal"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 17), // "QMap<QString,int>"
QT_MOC_LITERAL(4, 46, 13), // "widgetPrivils"
QT_MOC_LITERAL(5, 60, 4), // "onOK"
QT_MOC_LITERAL(6, 65, 8) // "onCancel"

    },
    "LoginForm\0userPrivilSignal\0\0"
    "QMap<QString,int>\0widgetPrivils\0onOK\0"
    "onCancel"
};
...
void LoginForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->userPrivilSignal((*reinterpret_cast< const QMap<QString,int>(*)>(_a[1]))); break;
        ...
        {
            typedef void (LoginForm::*_t)(const QMap<QString,int> & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginForm::userPrivilSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginForm::userPrivilSignal(const QMap<QString,int> & _t1)
{
