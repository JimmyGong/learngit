...
#include "../../../UI/MainForm/MainForm/configform.h"
...
const QMetaObject ConfigForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ConfigForm.data,
      qt_meta_data_ConfigForm,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ConfigForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ConfigForm.stringdata0))
        return static_cast<void*>(const_cast< ConfigForm*>(this));
